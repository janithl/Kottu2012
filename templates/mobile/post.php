<div data-role="content" data-theme="c">
	...
	<?php if(count($this->post) > 0): ?>
		...
		<a data-rel="back" href="./" data-mini="true" data-inline="true" data-icon="arrow-l" data-role="button">Go back</a>
		
		<a href="<?php echo config('basepath') . "/go.php?pid=" . $this->post['id'] . "&url=" . $this->post['link']; ?>"
		data-mini="true" data-inline="true" data-iconpos="right" data-icon="arrow-r" data-role="button" data-theme="b" target="_blank">Read full post</a>		
	<?php else: ?>
